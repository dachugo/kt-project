...
export default function Planes() {
  return (
    <>
      <section className="relative w-full lg:h-[70rem] h-[115rem] justify-center overflow-hidden p-5 z-10 bg-[#060606]">
        <div className="relative flex flex-col items-center justify-center px-10">
          ...
          <div className="flex lg:flex-row flex-col lg:gap-15 gap-10 my-5 mt-8 w-full justify-center">
            <button className="bg-[#FFFFFF] lg:w-80 w-full lg:h-130 h-90 rounded-xl">
              Boton 1
            </button>
            <button className="bg-[#FFFFFF] lg:w-80 w-full lg:h-130 h-90 rounded-xl">
              Boton 2
